...
const firebaseConfig = {
  apiKey: "AIzaSyCwcdmyvkM9l70uRVXvyEO8Dhf-Hm0lFT4",
  authDomain: "dental-ai-bot.firebaseapp.com",
  projectId: "dental-ai-bot",
  storageBucket: "dental-ai-bot.appspot.com",
  messagingSenderId: "40638990948",
  appId: "1:40638990948:web:b7f1afc6b64de9a0f6ed71"
};
...
function Bubbles(container, self, options) {
  ...
  interactionsSave = function(say, reply) {
    ...
    database.ref("interactionsHistory").set(interactionsHistory)
  }
